...
-- Date        : Fri Nov 21 11:37:01 2025
-- Host        : 5CD322B22T running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/DevWorks/HDMI/HDMI.gen/sources_1/bd/design_1/ip/design_1_rgb2dvi_0_1/design_1_rgb2dvi_0_1_sim_netlist.vhdl
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_rgb2dvi_0_1_SyncAsync_6 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_rgb2dvi_0_1_SyncAsync_6 : entity is "SyncAsync";
end design_1_rgb2dvi_0_1_SyncAsync_6;

architecture STRUCTURE of design_1_rgb2dvi_0_1_SyncAsync_6 is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_rgb2dvi_0_1_SyncAsync__parameterized1\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_rgb2dvi_0_1_SyncAsync__parameterized1\ : entity is "SyncAsync";
end \design_1_rgb2dvi_0_1_SyncAsync__parameterized1\;

architecture STRUCTURE of \design_1_rgb2dvi_0_1_SyncAsync__parameterized1\ is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_rgb2dvi_0_1_ResetBridge_5 is
  port (
    AR : out STD_LOGIC_VECTOR ( 0 to 0 );
    aRst_n : in STD_LOGIC;
    PixelClk : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_rgb2dvi_0_1_ResetBridge_5 : entity is "ResetBridge";
end design_1_rgb2dvi_0_1_ResetBridge_5;

architecture STRUCTURE of design_1_rgb2dvi_0_1_ResetBridge_5 is
  signal aRst_int_0 : STD_LOGIC;
  attribute RTL_KEEP : string;
  attribute RTL_KEEP of aRst_int_0 : signal is "true";
begin
SyncAsyncx: entity work.design_1_rgb2dvi_0_1_SyncAsync_6
     port map (
      AR(0) => AR(0),
      AS(0) => aRst_int_0,
      PixelClk => PixelClk
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_rgb2dvi_0_1_ClockGen is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_rgb2dvi_0_1_ClockGen : entity is "ClockGen";
end design_1_rgb2dvi_0_1_ClockGen;

architecture STRUCTURE of design_1_rgb2dvi_0_1_ClockGen is
...
LockLostReset: entity work.design_1_rgb2dvi_0_1_ResetBridge_5
     port map (
      AR(0) => pRst,
      PixelClk => PixelClk,
      aRst_n => aRst_n
    );
PLL_LockSyncAsync: entity work.\design_1_rgb2dvi_0_1_SyncAsync__parameterized1\
     port map (
      D(0) => oOut,
      PixelClk => PixelClk,
...
entity design_1_rgb2dvi_0_1_rgb2dvi is
  ...
  attribute kClkPrimitive of design_1_rgb2dvi_0_1_rgb2dvi : entity is "MMCM";
  attribute kClkRange : integer;
  attribute kClkRange of design_1_rgb2dvi_0_1_rgb2dvi : entity is 3;
  ...
  attribute kGenerateSerialClk of design_1_rgb2dvi_0_1_rgb2dvi : entity is "TRUE";
  attribute kRstActiveHigh : string;
  attribute kRstActiveHigh of design_1_rgb2dvi_0_1_rgb2dvi : entity is "FALSE";
...
begin
\ClockGenInternal.ClockGenX\: entity work.design_1_rgb2dvi_0_1_ClockGen
     port map (
...
entity design_1_rgb2dvi_0_1 is
  ...
  attribute x_core_info of design_1_rgb2dvi_0_1 : entity is "rgb2dvi,Vivado 2025.1";
...
architecture STRUCTURE of design_1_rgb2dvi_0_1 is
  ...
  attribute x_interface_parameter of PixelClk : signal is "XIL_INTERFACENAME PixelClk, FREQ_HZ 74218750, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
